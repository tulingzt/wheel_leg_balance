...
//                log_scope_get_data(lqr.X_fdb[8]);
...
void debug_task(void const* argument)
{
    ...
    for(;;)
    {
        ...
        if(test_hex>2)
        {                      
//            log_printf("{%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f},\n"\
//            ,lqr.X_fdb[0],\
//            lqr.X_fdb[1],lqr.X_fdb[2],lqr.X_fdb[3],lqr.X_fdb[4],lqr.X_fdb[5],lqr.X_fdb[6],lqr.X_fdb[7],\
//            lqr.X_fdb[8],lqr.X_fdb[9],wlr.side[0].Fn_kal,wlr.side[1].Fn_kal);
            
//        log_printf("{%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f},\n"\
//            ,lqr.X_fdb[0],\
//            lqr.X_fdb[1],lqr.X_fdb[2],lqr.X_fdb[3],lqr.X_fdb[4],lqr.X_fdb[5],lqr.X_fdb[6],lqr.X_fdb[7],\
//            lqr.X_fdb[8],lqr.X_fdb[9]);
        test_hex=0;
        }
        test_hex++;
