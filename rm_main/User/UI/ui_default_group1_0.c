...
ui_interface_rect_t *ui_default_group1_power1 = (ui_interface_rect_t *)&(ui_default_group1_0.data[3]);
ui_interface_round_t *ui_default_group1_position1 = (ui_interface_round_t *)&(ui_default_group1_0.data[4]);
...
void _ui_init_default_group1_0(void) {
    ...
    ui_default_group1_borad1->color = 4;
